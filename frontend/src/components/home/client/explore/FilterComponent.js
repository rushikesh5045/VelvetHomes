...
const FilterComponent = ({ onFilterChange, uniqueCompanies, companyDetailsMap }) => {
  ...
  return (
    <>
    <Box mt={2} mb={2} display="flex"  alignItems="center" justifyContent="spcae-between">
      ...
      <div style={{ marginLeft: '10px', flex: '1' }}>
        <Button
          variant="contained"
          onClick={applyFilter}
          style={{ backgroundColor: 'black', color: 'whitesmoke', fontSize: '10px' }}
        >
          Apply Filter
        </Button>
      </div>
